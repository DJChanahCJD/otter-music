...
- **播放生态**：支持播放列表、最近播放、个人歌单、歌词显示、音质选择、倍速调节、睡眠定时、横屏播放模式、车载蓝牙歌词与主题切换。
...
| 酷我音乐          |  ✅  |  ✅  |  ✅  |    ✅    | GD Studio API                                   |
| 咪咕音乐          |  ✅  |  ✅  |  ✅  |    ✅    | 仅移动端                                        |
| QQ音乐            |  ✅  |  ✅  |  ✅  |    ✅    | QQ音乐官方；需 Cookie 登录                      |
| Higequ            |  ✅  |  ✅  |  ✅  |    ❌    | [Hi歌曲音乐网](https://higequ.com/)，仅标准音质 |
| 酷狗音乐          |  ❌  |  ❌  |  ❌  |    ✅    |                                                 |
| 本地音乐          |  ❌  |  ✅  |  ✅  |    ❌    | 仅移动端支持                                    |
| 播客（歌单广场）  |  ✅  |  ✅  |  ❌  |    ❌    | RSS 播客订阅，支持小宇宙链接与 OPML 批量导入    |
